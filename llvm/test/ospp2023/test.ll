...
define dso_local i32 @my_abs_1(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_2(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp sgt i32 %x, %y
  %sub = sub nsw i32 %x, %y
...
define dso_local i32 @my_abs_3(i32 noundef %x, i32 noundef %y) local_unnamed_addr #1 {
entry:
  %cmp = icmp sgt i32 %x, %y
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_4(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp sgt i32 %x, %y
  %.neg = add i32 %x, 1
...
!3 = !{!"clang version 17.0.0 (https://mirrors.tuna.tsinghua.edu.cn/git/llvm-project.git e45a0c299449b48ac882c08c92a56952d893129d)"}
