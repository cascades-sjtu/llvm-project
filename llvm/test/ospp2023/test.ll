...
define dso_local i32 @my_abs_0_Good(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_0_Bad(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
...
cond.true:                                        ; preds = %entry
  ...
  %neg = xor i32 %sub, -1
  %call = select i1 %0, i32 %neg, i32 %add
  br label %cond.end
...
define dso_local i32 @my_abs_1_Bad(i32 noundef %x, i32 noundef %y) local_unnamed_addr #1 {
entry:
  %cmp = icmp slt i32 %x, %y
  br i1 %cmp, label %cond.true, label %cond.end
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_2_Neg(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp slt i32 %x, %y
  %sub.neg = sub i32 %y, %x
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_3_Neg(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp slt i32 %x, %y
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_4_Neg(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp sgt i32 %x, %y
  %.neg = add i32 %x, 1
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @my_abs_4_Bad(i32 noundef %x, i32 noundef %y) local_unnamed_addr #1 {
entry:
  %cmp = icmp slt i32 %x, %y
  br i1 %cmp, label %cond.true, label %cond.end
...
!3 = !{!"clang version 18.0.0 (https://mirrors.tuna.tsinghua.edu.cn/git/llvm-project.git cd547f19ed4c55dcde622f5ee140ec1c73b1876e)"}
